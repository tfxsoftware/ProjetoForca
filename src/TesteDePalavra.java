...
class TesteDePalavra
{
    public static void main (String[] args)
    {
        ...
        try
        {
            ...
            System.err.println ("Achamos a 1a aparicao da letra 'E' em \"PARALELEPIPEDO\" E NAO ERA PARA ACHARMOS");
        }
        catch (Exception erro)
        {
            System.out.println ("Deu erro ao achar a 1a aparicao da letra 'E' em \"PARALELEPIPEDO\" E ERA PARA DAR ERRO MESMO");
        }
        // teste 9
        try
        {
        ...
        // teste 18
        System.out.println ("Eh "+p3.equals(p3)+" que \"PARALELEPIPEDO\" eh igual (pelo equals) ao String \"PARALELEPIPEDO\"");
        // teste 19
